...
def setup_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('SQLALCHEMY_DATABASE_URI', 'sqlite:///quizmaster_database.sqlite3')  # Database URI from .env
    ...
    app.debug = True
    print("Quiz Application starting...  Under process!!!")
